...
def MatchingMethod(param):
    ...
    ## [imshow]
        cv.rectangle(img_display, matchLoc, (matchLoc[0] + templ.shape[0], matchLoc[1] + templ.shape[1]), (102, 255, 255), 2, 8, 0)
        cv.rectangle(result, matchLoc, (matchLoc[0] + templ.shape[0], matchLoc[1] + templ.shape[1]), (90, 50, 40), 2, 8, 0)
        n = n - 1
